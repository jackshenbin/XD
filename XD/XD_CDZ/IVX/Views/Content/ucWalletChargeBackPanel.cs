...
{        
    ...
    public partial class ucWalletChargeBackPanel : UserControl
    {

        public ucWalletChargeBackPanel()
        {
            InitializeComponent();
