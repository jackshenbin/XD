    ...
    public partial class ucWalletReChargePanel : UserControl
    {
        ...
        private void btnSubWallet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sms_sqlstr = "update user_card_list_t set elec_pkg_balance = " + newcashwallet.ToString() + "  where card_state=1 and user_card_id='" + textBoxCardID.Value + "'";
