...
namespace BOCOM.IVX.Model
{
    ...
    public class UIFuncItemInfo
    {
        ...
        public static UIFuncItemInfo RUNNINGTASKS = new UIFuncItemInfo(UIFunctionEnum.RunningTasks, "正在进行的任务", TASK);
        public static UIFuncItemInfo FINISHEDTASKS = new UIFuncItemInfo(UIFunctionEnum.FinishedTasks, "已经完成的任务", TASK);
        ...
        public static UIFuncItemInfo VDASERVERMANAGEMENT = new UIFuncItemInfo(UIFunctionEnum.VDAServerManagement, "分析服务器", CONFIGURATION);
        ...
        public static UIFuncItemInfo CASEEXPORT = new UIFuncItemInfo(UIFunctionEnum.CaseExport, "案件导出");
        
        public static UIFuncItemInfo TAGEXPORT = new UIFuncItemInfo(UIFunctionEnum.TagExport, "标签导出");
